...
public class Skill_Passive_General_Toughness : SkillEntity, Skill, Learnable
{
    ...
    public bool setSkillLevel(float change)
    {
        ...
        {
            case 10: if (effect < 1) effect = 1; playerInstance.player.changeStats(0, 0, 0, 0, 0, 0, 1, 0, 0); break;
            case 20: if (effect < 2) effect = 2; playerInstance.player.changeStats(0, 0, 0, 0, 0, 0, 1, 0, 0); break;
            case 30: if (effect < 3) effect = 3; playerInstance.player.changeStats(0, 0, 0, 0, 0, 0, 1, 0, 0); break;
            case 40: if (effect < 4) effect = 4; playerInstance.player.changeStats(0, 0, 0, 0, 0, 0, 1, 0, 0); break;
            case 50: if (effect < 5) effect = 5; playerInstance.player.changeStats(0, 0, 0, 0, 0, 0, 1, 0, 0); break;
            case 60: if (effect < 6) effect = 6; playerInstance.player.changeStats(0, 0, 0, 0, 0, 0, 1, 0, 0); break;
            case 70: if (effect < 7) effect = 7; playerInstance.player.changeStats(0, 0, 0, 0, 0, 0, 1, 0, 0); break;
            case 80: if (effect < 8) effect = 8; playerInstance.player.changeStats(0, 0, 0, 0, 0, 0, 1, 0, 0); break;
            case 90: if (effect < 9) effect = 9; playerInstance.player.changeStats(0, 0, 0, 0, 0, 0, 1, 0, 0); break;
            case 100: if (effect < 10) effect = 10; playerInstance.player.changeStats(0, 0, 0, 0, 0, 0, 1, 0, 0); break;
    ...
    {
        if (playerInstance.player.getHealthFloat() >= 250)
        {
            return true;
        }
        return false;
