...
public class Skill_Passive_General_Riding : SkillEntity, Skill
{
	private static int id = 15;
    private static string type = "passive";
    private static string group = "general";
    private static string skillName = "Riding";
    private static string skillDescription = "Riding reduces stamina cost for riding mounts";
