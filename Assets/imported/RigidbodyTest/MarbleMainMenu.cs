...
public class MarbleMainMenu : MonoBehaviour
{
    ...
    private void JoinedAGame()
    {
        Debug.Log("Joined & Spawning");
        PhotonNetwork.Instantiate("Marble", transform.position, Quaternion.identity, 0);
    }
